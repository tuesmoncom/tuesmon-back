...
- Fix epics excluded filter (https://manage.tuesmon.com/project/tuesmon/issue/5727)
...
- Due dates configuration (https://manage.tuesmon.com/project/tuesmon/issue/3070):
    - Add due dates to admin attributes
    - Update project templates
- Issues to Sprints (https://manage.tuesmon.com/project/tuesmon/issue/1181):
...
- Add due date to US, tasks and issues (https://manage.tuesmon.com/project/tuesmon/issue/3070):
    - Add to csv export.
    - Add to projects import/export.
    - Add to webhooks.
    - Add to django admin.
- Add multiple assignement only in US (https://manage.tuesmon.com/project/tuesmon/issue/1961):
    - The `assigned_to` field is still active.
    - Add to csv export.
    - Add to projects import/export.
    - Add to webhooks.
    - Add to django admin.
- Delete cards in Kanban and sprint Taskboard (https://manage.tuesmon.com/project/tuesmon/issue/2683).
...
- [API] Add tribe_gig field to user stories (improve integration between Tuesmon and Tuesmon Tribe).
...
- Add externall apps: now Tuesmon can integrate with hundreds of applications and service.
...
- Add sitemap of tuesmon-front (the web client).
...
- Gitlab integration:
  + Change status of user stories, tasks and issues with the commit messages.
  + Sync issues creation in Tuesmon from Gitlab.
- Support throttling.
  + for anonymous users
...
- GitHub integration (Phase I):
  ...
  + Change status of user stories, tasks and issues with the commit messages.
  + Sync issues creation in Tuesmon from GitHub.
  + Sync comments in Tuesmon from GitHub issues.
