...
import tuesmon.external_apps.models
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            name='Application',
            fields=[
                ('id', models.CharField(serialize=False, unique=True, max_length=255, default=tuesmon.external_apps.models._generate_uuid, primary_key=True)),
