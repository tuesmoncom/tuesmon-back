...
import tuesmon.projects.history.models
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('default_options', tuesmon.base.db.models.fields.JSONField(null=True, verbose_name='default options', blank=True)),
                ('us_statuses', tuesmon.base.db.models.fields.JSONField(null=True, verbose_name='us statuses', blank=True)),
                ('points', tuesmon.base.db.models.fields.JSONField(null=True, verbose_name='points', blank=True)),
                ('task_statuses', tuesmon.base.db.models.fields.JSONField(null=True, verbose_name='task statuses', blank=True)),
                ('issue_statuses', tuesmon.base.db.models.fields.JSONField(null=True, verbose_name='issue statuses', blank=True)),
                ('issue_types', tuesmon.base.db.models.fields.JSONField(null=True, verbose_name='issue types', blank=True)),
                ('priorities', tuesmon.base.db.models.fields.JSONField(null=True, verbose_name='priorities', blank=True)),
                ('severities', tuesmon.base.db.models.fields.JSONField(null=True, verbose_name='severities', blank=True)),
                ('roles', tuesmon.base.db.models.fields.JSONField(null=True, verbose_name='roles', blank=True)),
            ],
            options={
