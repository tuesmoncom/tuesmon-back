...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            ...
            name='issue_duedates',
            field=tuesmon.base.db.models.fields.json.JSONField(blank=True, encoder=django.core.serializers.json.DjangoJSONEncoder, null=True, verbose_name='issue duedates'),
        ),
        migrations.AddField(
            model_name='projecttemplate',
            name='task_duedates',
            field=tuesmon.base.db.models.fields.json.JSONField(blank=True, encoder=django.core.serializers.json.DjangoJSONEncoder, null=True, verbose_name='task duedates'),
        ),
        migrations.AddField(
            model_name='projecttemplate',
            name='us_duedates',
            field=tuesmon.base.db.models.fields.json.JSONField(blank=True, encoder=django.core.serializers.json.DjangoJSONEncoder, null=True, verbose_name='us duedates'),
        ),
