...
from tuesmon.base.utils.db import get_object_or_none
...
from tuesmon.projects.tasks.validators import UpdateMilestoneBulkValidator as \
    TasksUpdateMilestoneValidator
from tuesmon.projects.issues.validators import UpdateMilestoneBulkValidator as \
...
class MilestoneViewSet(HistoryResourceMixin, WatchedResourceMixin,
    ...
    def list(self, request, *args, **kwargs):
        ...
        self._add_tuesmon_info_headers()
        return res

    def _add_tuesmon_info_headers(self):
        try:
        ...
        if project:
            ...
            self.headers["Tuesmon-Info-Total-Opened-Milestones"] = opened_milestones
            self.headers["Tuesmon-Info-Total-Closed-Milestones"] = closed_milestones
