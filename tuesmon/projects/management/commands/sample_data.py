...
from tuesmon.users.models import *
from tuesmon.permissions.choices import ANON_PERMISSIONS
from tuesmon.projects.choices import BLOCKED_BY_STAFF
from tuesmon.external_apps.models import Application, ApplicationToken
from tuesmon.projects.models import *
from tuesmon.projects.epics.models import *
from tuesmon.projects.milestones.models import *
from tuesmon.projects.notifications.choices import NotifyLevel
from tuesmon.projects.services.stats import get_stats_for_project
from tuesmon.projects.userstories.models import *
from tuesmon.projects.tasks.models import *
from tuesmon.projects.issues.models import *
from tuesmon.projects.wiki.models import *
from tuesmon.projects.attachments.models import *
from tuesmon.projects.custom_attributes.models import *
from tuesmon.projects.custom_attributes.choices import TYPES_CHOICES, TEXT_TYPE, MULTILINE_TYPE, DATE_TYPE, URL_TYPE
from tuesmon.projects.history.services import take_snapshot
from tuesmon.projects.likes.services import add_like
from tuesmon.projects.votes.services import add_vote
from tuesmon.events.apps import disconnect_events_signals
from tuesmon.projects.services.stats import get_stats_for_project


ATTACHMENT_SAMPLE_DATA = [
    "tuesmon/projects/management/commands/sample_data",
    [".txt", ]
]
...
URL_CHOICES = [
    "https://tuesmon.com",
    "https://blog.tuesmon.com",
    "https://manage.tuesmon.com",
    "https://tribe.tuesmon.com"]
...
class Command(BaseCommand):
    ...
    def create_user(self, counter=None, username=None, full_name=None, email=None):
        ...
        email = email or "user{0}@tuesmoncom.demo".format(counter)
