...
def connect_userstories_signals():
    from tuesmon.projects.tagging import signals as tagging_handlers
...
def connect_userstories_custom_attributes_signals():
    from tuesmon.projects.custom_attributes import signals as custom_attributes_handlers
...
class UserStoriesAppConfig(AppConfig):
    name = "tuesmon.projects.userstories"
