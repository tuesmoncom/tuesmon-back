...
from tuesmon.projects.due_dates.models import DueDateMixin
from tuesmon.projects.tagging.models import TaggedMixin
from tuesmon.projects.occ import OCCModelMixin
from tuesmon.projects.notifications.mixins import WatchedModelMixin
from tuesmon.projects.mixins.blocked import BlockedMixin
...
class UserStory(OCCModelMixin, WatchedModelMixin, BlockedMixin, TaggedMixin, DueDateMixin, models.Model):
    ...
    tribe_gig = PickledObjectField(null=True, blank=True, default=None,
                                   verbose_name="tuesmon tribe gig")
