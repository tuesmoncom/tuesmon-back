...
from tuesmon.base import filters as base_filters
from tuesmon.base import exceptions as exc
from tuesmon.base import response
from tuesmon.base import status
from tuesmon.base.decorators import list_route
from tuesmon.base.api.mixins import BlockedByProjectMixin
from tuesmon.base.api import ModelCrudViewSet
from tuesmon.base.api import ModelListViewSet
...
from tuesmon.projects.mixins.by_ref import ByRefMixin
from tuesmon.projects.models import Project, UserStoryStatus
from tuesmon.projects.notifications.mixins import AssignedUsersSignalMixin
from tuesmon.projects.notifications.mixins import WatchedResourceMixin
from tuesmon.projects.notifications.mixins import WatchersViewSetMixin
from tuesmon.projects.occ import OCCResourceMixin
from tuesmon.projects.tagging.api import TaggedResourceMixin
from tuesmon.projects.votes.mixins.viewsets import VotedResourceMixin
from tuesmon.projects.votes.mixins.viewsets import VotersViewSetMixin
from tuesmon.projects.userstories.utils import attach_extra_info
...
class UserStoryViewSet(AssignedUsersSignalMixin, OCCResourceMixin,
    ...
    def post_save(self, obj, created=False):
        if not created:
            ...
            orders_updated.update(updated)
            self.headers["Tuesmon-Info-Order-Updated"] = json.dumps(orders_updated)
