...
from tuesmon.base.api.permissions import TuesmonResourcePermission, AllowAny, IsAuthenticated, IsSuperUser
from tuesmon.permissions.permissions import HasProjectPerm, IsProjectAdmin

from tuesmon.permissions.permissions import CommentAndOrUpdatePerm


class UserStoryPermission(TuesmonResourcePermission):
...
class UserStoryVotersPermission(TuesmonResourcePermission):
    enought_perms = IsProjectAdmin() | IsSuperUser()
    global_perms = None
    retrieve_perms = HasProjectPerm('view_us')
...
class UserStoryWatchersPermission(TuesmonResourcePermission):
    enought_perms = IsProjectAdmin() | IsSuperUser()
    global_perms = None
    retrieve_perms = HasProjectPerm('view_us')
    list_perms = HasProjectPerm('view_us')
