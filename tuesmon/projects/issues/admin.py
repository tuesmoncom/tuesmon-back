...
from tuesmon.projects.attachments.admin import AttachmentInline
from tuesmon.projects.notifications.admin import WatchedInline
from tuesmon.projects.votes.admin import VoteInline
