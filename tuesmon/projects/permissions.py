...
from tuesmon.base.api.permissions import TuesmonResourcePermission
from tuesmon.base.api.permissions import IsAuthenticated
from tuesmon.base.api.permissions import AllowAny
from tuesmon.base.api.permissions import IsSuperUser
from tuesmon.base.api.permissions import IsObjectOwner
from tuesmon.base.api.permissions import PermissionComponent

from tuesmon.base import exceptions as exc

from tuesmon.permissions.permissions import HasProjectPerm
from tuesmon.permissions.permissions import IsProjectAdmin
...
class ProjectFansPermission(TuesmonResourcePermission):
...
class ProjectWatchersPermission(TuesmonResourcePermission):
    enought_perms = IsProjectAdmin() | IsSuperUser()
    global_perms = None
    retrieve_perms = HasProjectPerm('view_project')
    list_perms = HasProjectPerm('view_project')
...
class EpicStatusPermission(TuesmonResourcePermission):
    retrieve_perms = HasProjectPerm('view_project')
    create_perms = IsProjectAdmin()
    update_perms = IsProjectAdmin()
    partial_update_perms = IsProjectAdmin()
...
class PointsPermission(TuesmonResourcePermission):
    retrieve_perms = HasProjectPerm('view_project')
    create_perms = IsProjectAdmin()
    update_perms = IsProjectAdmin()
    partial_update_perms = IsProjectAdmin()
...
class UserStoryStatusPermission(TuesmonResourcePermission):
    retrieve_perms = HasProjectPerm('view_project')
    create_perms = IsProjectAdmin()
    update_perms = IsProjectAdmin()
    partial_update_perms = IsProjectAdmin()
...
class TaskStatusPermission(TuesmonResourcePermission):
    retrieve_perms = HasProjectPerm('view_project')
    create_perms = IsProjectAdmin()
    update_perms = IsProjectAdmin()
    partial_update_perms = IsProjectAdmin()
...
class TaskDueDatePermission(TuesmonResourcePermission):
    retrieve_perms = HasProjectPerm('view_project')
    create_perms = IsProjectAdmin()
    update_perms = IsProjectAdmin()
    partial_update_perms = IsProjectAdmin()
...
class SeverityPermission(TuesmonResourcePermission):
    retrieve_perms = HasProjectPerm('view_project')
    create_perms = IsProjectAdmin()
    update_perms = IsProjectAdmin()
    partial_update_perms = IsProjectAdmin()
...
class PriorityPermission(TuesmonResourcePermission):
    retrieve_perms = HasProjectPerm('view_project')
    create_perms = IsProjectAdmin()
    update_perms = IsProjectAdmin()
    partial_update_perms = IsProjectAdmin()
...
class IssueStatusPermission(TuesmonResourcePermission):
    retrieve_perms = HasProjectPerm('view_project')
    create_perms = IsProjectAdmin()
    update_perms = IsProjectAdmin()
    partial_update_perms = IsProjectAdmin()
...
class IssueTypePermission(TuesmonResourcePermission):
    retrieve_perms = HasProjectPerm('view_project')
    create_perms = IsProjectAdmin()
    update_perms = IsProjectAdmin()
    partial_update_perms = IsProjectAdmin()
...
class IssueDueDatePermission(TuesmonResourcePermission):
    retrieve_perms = HasProjectPerm('view_project')
    create_perms = IsProjectAdmin()
    update_perms = IsProjectAdmin()
    partial_update_perms = IsProjectAdmin()
