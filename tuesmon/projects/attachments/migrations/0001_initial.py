...
import tuesmon.projects.attachments.models
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('attached_file', models.FileField(verbose_name='attached file', upload_to=tuesmon.projects.attachments.models.get_attachment_file_path, blank=True, null=True, max_length=500)),
