...
class EpicAttachmentPermission(TuesmonResourcePermission):
...
class UserStoryAttachmentPermission(TuesmonResourcePermission):
...
class TaskAttachmentPermission(TuesmonResourcePermission):
...
class IssueAttachmentPermission(TuesmonResourcePermission):
...
class RawAttachmentPermission(TuesmonResourcePermission):
