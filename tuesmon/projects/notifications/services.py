...
from tuesmon.base.mails import InlineCSSTemplateMail
...
from tuesmon.projects.history.services import (make_key_from_model_object,
                                             get_last_snapshot_for_key,
                                             get_model_from_key)
from tuesmon.permissions.services import user_has_perm
...
def get_mentions(project: object, text: str):
    from tuesmon.mdrender.service import render_and_extract
...
def get_watched(user_or_id, model):
    ...
    :param user_or_id: :class:`~tuesmon.users.models.User` instance or id.
...
def add_watcher(obj, user):
    ...
    :param obj: Any Django model instance.
    :param user: User adding the watch. :class:`~tuesmon.users.models.User` instance.
    """
    obj_type = apps.get_model("contenttypes", "ContentType").objects.get_for_model(obj)
...
def remove_watcher(obj, user):
    ...
    :param obj: Any Django model instance.
    :param user: User removing the watch. :class:`~tuesmon.users.models.User` instance.
    """
    obj_type = apps.get_model("contenttypes", "ContentType").objects.get_for_model(obj)
