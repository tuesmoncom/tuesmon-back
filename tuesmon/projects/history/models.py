...
from tuesmon.mdrender.service import get_diff_of_htmls

from .choices import HistoryType
from .choices import HISTORY_TYPE_CHOICES

from tuesmon.base.utils.diff import make_diff as make_diff_from_dicts
from tuesmon.projects.custom_attributes.choices import CHECKBOX_TYPE, NUMBER_TYPE, TEXT_TYPE
