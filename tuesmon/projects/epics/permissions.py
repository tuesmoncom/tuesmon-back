...
from tuesmon.base.api.permissions import TuesmonResourcePermission, AllowAny, IsAuthenticated
from tuesmon.base.api.permissions import IsSuperUser, HasProjectPerm, IsProjectAdmin

from tuesmon.permissions.permissions import CommentAndOrUpdatePerm


class EpicPermission(TuesmonResourcePermission):
...
class EpicRelatedUserStoryPermission(TuesmonResourcePermission):
    enought_perms = IsProjectAdmin() | IsSuperUser()
    global_perms = None
    retrieve_perms = HasProjectPerm('view_epics')
...
class EpicVotersPermission(TuesmonResourcePermission):
    enought_perms = IsProjectAdmin() | IsSuperUser()
    global_perms = None
    retrieve_perms = HasProjectPerm('view_epics')
...
class EpicWatchersPermission(TuesmonResourcePermission):
    enought_perms = IsProjectAdmin() | IsSuperUser()
    global_perms = None
    retrieve_perms = HasProjectPerm('view_epics')
    list_perms = HasProjectPerm('view_epics')
