...
from tuesmon.permissions import permissions
from tuesmon.projects.notifications.admin import NotifyPolicyInline
from tuesmon.projects.likes.admin import LikeInline
from tuesmon.users.admin import RoleInline
...
class ProjectAdmin(admin.ModelAdmin):
    ...
    def delete_selected(self, request, queryset):
        # NOTE: This must be equal to tuesmon.projects.models.Project.delete_related_content
