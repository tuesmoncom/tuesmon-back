...
from tuesmon.base.db.models.fields import JSONField

from tuesmon.base.utils.time import timestamp_ms
from tuesmon.projects.custom_attributes.models import EpicCustomAttribute
from tuesmon.projects.custom_attributes.models import UserStoryCustomAttribute
from tuesmon.projects.custom_attributes.models import TaskCustomAttribute
from tuesmon.projects.custom_attributes.models import IssueCustomAttribute
from tuesmon.projects.tagging.models import TaggedMixin
from tuesmon.projects.tagging.models import TagsColorsMixin
from tuesmon.base.utils.files import get_file_path
from tuesmon.base.utils.slug import slugify_uniquely
from tuesmon.base.utils.slug import slugify_uniquely_for_queryset

from tuesmon.permissions.choices import ANON_PERMISSIONS, MEMBERS_PERMISSIONS

from tuesmon.projects.notifications.choices import NotifyLevel
from tuesmon.projects.notifications.services import (
    set_notify_policy_level,
    set_notify_policy_level_to_ignore,
    create_notify_policy_if_not_exists)

from tuesmon.timeline.service import build_project_namespace
...
class Project(ProjectDefaults, TaggedMixin, TagsColorsMixin, models.Model):
    ...
    def delete_related_content(self):
        # NOTE: Remember to update code in tuesmon.projects.admin.ProjectAdmin.delete_selected
        from tuesmon.events.apps import (connect_events_signals,
                                       disconnect_events_signals)
        from tuesmon.projects.epics.apps import (connect_all_epics_signals,
                                             disconnect_all_epics_signals)
        from tuesmon.projects.tasks.apps import (connect_all_tasks_signals,
                                               disconnect_all_tasks_signals)
        from tuesmon.projects.userstories.apps import (connect_all_userstories_signals,
                                                     disconnect_all_userstories_signals)
        from tuesmon.projects.issues.apps import (connect_all_issues_signals,
                                                disconnect_all_issues_signals)
        from tuesmon.projects.apps import (connect_memberships_signals,
