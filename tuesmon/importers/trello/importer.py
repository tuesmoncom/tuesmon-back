...
from tuesmon.projects.services import projects as projects_service
...
from tuesmon.base import exceptions
    ...
    def list_users(self, project_id):
        ...
        for member in self._client.get("/board/{}/members/all".format(project_id), {"fields": "id"}):
            ...
            try:
                ...
                #
                # File "/home/tuesmon/tuesmon-back/tuesmon/importers/trello/importer.py" in list_users
