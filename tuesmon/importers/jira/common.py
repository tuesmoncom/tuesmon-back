...
from tuesmon.projects.models import Points
...
from tuesmon.front.templatetags.functions import resolve as resolve_front_url
...
class JiraImporterCommon:
            ...
            if custom_field['custom']:
                if custom_field['schema']['custom'] == "com.pyxis.greenhopper.jira:gh-sprint":
                    ...
                    custom_fields.append({
                        ...
                        "tuesmon_field_name": custom_field['name'][:64],
                    })
    ...
    def _import_to_custom_fields(self, obj, issue, options):
        ...
        for custom_field in self.custom_fields:
            ...
            if data:
                tuesmon_field = custom_att_manager.get(name=custom_field['tuesmon_field_name'])
                custom_attributes_values[tuesmon_field.id] = data
