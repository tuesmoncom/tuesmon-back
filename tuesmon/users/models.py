...
from tuesmon.base.utils.colors import generate_random_hex_color
...
from tuesmon.projects.choices import BLOCKED_BY_OWNER_LEAVING
...
class User(AbstractBaseUser, PermissionsMixin):
    ...
    def cancel(self):
        with advisory_lock("delete-user"):
            ...
            self.email = "{}@tuesmon.com".format(self.username)
