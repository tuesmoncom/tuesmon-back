...
# It has to be run inside the tuesmon-back git root directory.
#
# The following commands are available:
#
# * update_catalogs: check for new strings in tuesmon-back catalogs, and
...
#
#  $ python scripts/manage_translations.py lang_stats --language=es --resources=tuesmon
...
def _tx_resource_for_name(name):
    ...
    return "tuesmon-back.{}".format(name)
...
def update_catalogs(resources=None, languages=None):
    ...
    os.chdir(os.getcwd())
    print("Updating en catalogs for all tuesmon-back resourcess...")
    cmd.handle(**opts)
...
def lang_stats(resources=None, languages=None):
    ...
    limit the output (e.g. ['main', 'tuesmon']).
    """
...
You need transifex-client, install it.
 ...
 2. Create ~/.transifexrc file:
    ...
    parser = ArgumentParser(description="manage translations in tuesmon-back between the repo and transifex.",
