...
LOCALE_PATHS = (
    ...
    os.path.join(BASE_DIR, "tuesmon", "locale"),
)
...
# Events backend
EVENTS_PUSH_BACKEND = "tuesmon.events.backends.postgresql.EventsPushBackend"
...
# something like https://media.tuesmon.com/
...
# Default storage
DEFAULT_FILE_STORAGE = "tuesmon.base.storage.FileSystemStorage"
...
MIDDLEWARE_CLASSES = [
    "tuesmon.base.middleware.cors.CoorsMiddleware",
    "tuesmon.events.middleware.SessionIDMiddleware",
...
INSTALLED_APPS = [
    ...
    "tuesmon.users",
    "tuesmon.userstorage",
    "tuesmon.external_apps",
    "tuesmon.projects",
    "tuesmon.projects.references",
    "tuesmon.projects.custom_attributes",
    "tuesmon.projects.history",
    "tuesmon.projects.notifications",
    "tuesmon.projects.attachments",
    "tuesmon.projects.likes",
    "tuesmon.projects.votes",
    "tuesmon.projects.milestones",
    "tuesmon.projects.epics",
    "tuesmon.projects.userstories",
    "tuesmon.projects.tasks",
    "tuesmon.projects.issues",
    "tuesmon.projects.wiki",
    "tuesmon.projects.contact",
    "tuesmon.projects.settings",
    "tuesmon.searches",
    "tuesmon.timeline",
    "tuesmon.mdrender",
    "tuesmon.export_import",
    "tuesmon.feedback",
    "tuesmon.stats",
    "tuesmon.hooks.github",
    "tuesmon.hooks.gitlab",
    "tuesmon.hooks.bitbucket",
    "tuesmon.hooks.gogs",
    "tuesmon.webhooks",
    "tuesmon.importers",
...
WSGI_APPLICATION = "tuesmon.wsgi.application"
...
FORMAT_MODULE_PATH = "tuesmon.base.formats"
...
REST_FRAMEWORK = {
    "DEFAULT_AUTHENTICATION_CLASSES": (
        # Mainly used by tuesmon-front
        "tuesmon.auth.backends.Token",

        # Mainly used for api debug.
        "tuesmon.auth.backends.Session",

        # Application tokens auth
        "tuesmon.external_apps.auth_backends.Token",
    ),
    "DEFAULT_THROTTLE_CLASSES": (
        "tuesmon.base.throttling.CommonThrottle",
    ),
    ...
    "FILTER_BACKEND": "tuesmon.base.filters.FilterBackend",
    "EXCEPTION_HANDLER": "tuesmon.base.exceptions.exception_handler",
    "PAGINATE_BY": 30,
...
# Extra expose header related to Tuesmon APP (see tuesmon.base.middleware.cors=)
APP_EXTRA_EXPOSE_HEADERS = [
    "tuesmon-info-total-opened-milestones",
    "tuesmon-info-total-closed-milestones",
    "tuesmon-info-project-memberships",
    "tuesmon-info-project-is-private",
    "tuesmon-info-order-updated"
]
...
FEEDBACK_EMAIL = "support@tuesmon.com"
...
PROJECT_MODULES_CONFIGURATORS = {
    "github": "tuesmon.hooks.github.services.get_or_generate_config",
    "gitlab": "tuesmon.hooks.gitlab.services.get_or_generate_config",
    "bitbucket": "tuesmon.hooks.bitbucket.services.get_or_generate_config",
    "gogs": "tuesmon.hooks.gogs.services.get_or_generate_config",
}
...
# If is True /front/sitemap.xml show a valid sitemap of tuesmon-front client
