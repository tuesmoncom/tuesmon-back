...
from tuesmon.projects.history import services as history_services
from tuesmon.timeline import service
from tuesmon.timeline.models import Timeline
from tuesmon.timeline.serializers import TimelineSerializer
