...
def test_invalid_concurrent_save_for_wiki_page(client):
    ...
    mock_path = "tuesmon.projects.wiki.api.WikiViewSet.pre_conditions_on_save"
    with patch(mock_path):
...
def test_invalid_concurrent_save_for_us(client):
    ...
    mock_path = "tuesmon.projects.userstories.api.UserStoryViewSet.pre_conditions_on_save"
    with patch(mock_path):
        url = reverse("userstories-list")
        data = {"subject": "test",
                "project": project.id,
