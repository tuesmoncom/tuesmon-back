...
from tuesmon.mdrender.service import render, render_and_extract
...
def test_proccessor_valid_email():
    result = render(dummy_project, "**beta.tester@tuesmon.com**")
    expected_result = "<p><strong><a href=\"mailto:beta.tester@tuesmon.com\" target=\"_blank\">beta.tester@tuesmon.com</a></strong></p>"
    assert result == expected_result
