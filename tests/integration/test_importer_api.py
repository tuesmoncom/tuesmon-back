...
from tuesmon.export_import import services
from tuesmon.export_import.exceptions import  TuesmonImportError
...
def test_valid_project_import_without_extra_data(client):
    user = f.UserFactory.create()
    user_watching = f.UserFactory.create(email="testing@tuesmon.com")
    client.login(user)
...
##################################################################
## tes tuesmon.export_import.services.store_project_from_dict
##################################################################
...
def test_services_store_project_from_dict_with_no_projects_slots_available(client):
    ...
    with pytest.raises(TuesmonImportError) as excinfo:
