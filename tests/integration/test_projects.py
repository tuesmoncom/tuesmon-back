...
from tuesmon.projects.services import stats as stats_services
...
from tuesmon.projects.choices import BLOCKED_BY_DELETING
from tuesmon.timeline.service import get_project_timeline
...
def test_create_private_project_without_enough_private_projects_slots(client):
    ...
    assert response["Tuesmon-Info-Project-Memberships"] == "1"
    assert response["Tuesmon-Info-Project-Is-Private"] == "True"
...
def test_create_public_project_without_enough_public_projects_slots(client):
    ...
    assert response["Tuesmon-Info-Project-Memberships"] == "1"
    assert response["Tuesmon-Info-Project-Is-Private"] == "False"
...
####################################################################################
# Test tuesmon.projects.services.projects.check_if_project_privacity_can_be_changed
####################################################################################

from tuesmon.projects.services.projects import (
...
####################################################################################
# Test tuesmon.projects.services.projects.check_if_project_is_out_of_owner_limit
####################################################################################

from tuesmon.projects.services.projects import check_if_project_is_out_of_owner_limits
...
def test_delete_project_with_celery_enabled(client, settings):
    ...
    with mock.patch('tuesmon.projects.services.delete_project') as delete_project_mock:
...
def test_duplicate_private_project_without_enough_memberships_slots(client):
    ...
    assert response["Tuesmon-Info-Project-Memberships"] == "2"
    assert response["Tuesmon-Info-Project-Is-Private"] == "True"
