...
from tuesmon.mdrender.extensions import emojify
from tuesmon.mdrender.service import render, cache_by_sha, get_diff_of_htmls, render_and_extract
...
def test_mentions_valid_username():
    with patch("tuesmon.mdrender.extensions.mentions.get_user_model") as get_user_model_mock:
...
def test_proccessor_valid_us_reference():
    with patch("tuesmon.mdrender.extensions.references.get_instance_by_ref") as mock:
